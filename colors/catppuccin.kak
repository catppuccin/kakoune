...
set-face	global	PrimaryCursorEol	"%opt{gray0},%opt{red}"
...
set-face	global	MenuInfo			"%opt{black1},%opt{lavender}"
set-face	global	Information			"%opt{black1},%opt{lavender}"
set-face	global	Error				"%opt{red},%opt{gray1}"
...
set-face	global	Prompt				"%opt{green},%opt{gray0}"
set-face	global	MatchingChar		"%opt{blue},%opt{black2}"
set-face	global	Whitespace			"%opt{black1},%opt{background}+f"
